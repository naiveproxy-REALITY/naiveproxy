...
#pragma redefine_extname SSL_set1_reality_config BORINGSSL_ADD_USER_LABEL_AND_PREFIX(SSL_set1_reality_config)
#pragma redefine_extname SSL_verify_reality_peer_certificate BORINGSSL_ADD_USER_LABEL_AND_PREFIX(SSL_verify_reality_peer_certificate)
...
#define SSL_set1_reality_config BORINGSSL_ADD_PREFIX(SSL_set1_reality_config)
#define SSL_verify_reality_peer_certificate BORINGSSL_ADD_PREFIX(SSL_verify_reality_peer_certificate)
